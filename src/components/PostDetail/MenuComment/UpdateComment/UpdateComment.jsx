...
const UpdateComment = ({
    ...
    const handleUpdateComment = (e) => {
        ...
        if (content === "") {
            ...
            dispatch(updateComment({ _id: commentId, content }));
            handleClose();
            setContent("");
        }
    };
    ...
    return (
        ...
        >
            ...
            >
                ...
                <IoClose
                    onClick={() => setUpdateCommentFlag(false)}
                    ...
                    <div className="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
                        ...
                        <div className="flex items-center justify-between px-3 py-2 border-t dark:border-gray-600">
                            ...
                            <div>
                                <button
                                    type="submit"
                                    className="text-white bg-gradient-to-r from-green-500 via-green-600 to-green-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center"
                                >
                                    Update comment
                                </button>
                            </div>
